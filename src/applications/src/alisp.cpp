...
int main(int argc, char *argv[])
{
	...
	auto cli = Help(showHelp)
		...
		| Opt(opts.parse_debug, "bool")["-d"]["--parse-debug"]("Debug output from the parser")
		| Opt(opts.eval_debug, "bool")["-l"]["--eval-debug"]("Debug output from the evaluator")
		| Opt(opts.interactive, "bool")["-i"]["--iteractive"]("Start interactive mode after file evaluation")
