...
#define AL_LOG(MSG, TAG) do{ ::alisp::logging::LOGGER.create_entry(MSG, __FILE__, __FUNCTION__, __LINE__, ::alisp::logging::LogCategory::TAG); }while(false)
#else
using standard_logger = LogKeeper<NoopLog>;

#define AL_LOG(MSG, TAG) do{(void)0;}while(false)
#endif
