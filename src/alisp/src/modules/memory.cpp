...
ALObjectPtr Fmmap(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fget_size(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fset_nth_byte(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<3>(t_obj));
    auto mem  = eval->eval(t_obj->i(0));
...
ALObjectPtr Fget_nth_byte(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fget_range(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<3>(t_obj));
    auto mem   = eval->eval(t_obj->i(0));
...
ALObjectPtr Ffill_bytes(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<2>(t_obj));
    auto mem = eval->eval(t_obj->i(0));
...
ALObjectPtr Fset_bytes(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<2>(t_obj));
    auto mem   = eval->eval(t_obj->i(0));
...
ALObjectPtr Fget_bytes(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<1>(t_obj));
    auto mem = eval->eval(t_obj->i(0));
    AL_CHECK(assert_memory(mem));
...
ALObjectPtr Fallocate_buffer(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<1>(t_obj));
...
ALObjectPtr Frelease_buffer(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_size<1>(t_obj));
    auto mem = eval->eval(t_obj->i(0));
    AL_CHECK(assert_memory(mem));
