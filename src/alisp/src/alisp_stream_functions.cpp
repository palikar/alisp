...
ALObjectPtr Fstream_write(ALObjectPtr t_obj, env::Environment *, eval::Evaluator *eval)
{
    ...
    CHECK(assert_int(stream_obj));
    CHECK(assert_stream(stream_obj));
