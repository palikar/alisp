...
ALObjectPtr Fnum_true_name(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fnum_false_name(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fnum_thousand_sep(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fnum_decimal_point(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fmoney_positive_sign(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fmoney_negative_sign(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fmoney_symobl(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fmoney_thousand_sep(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fmoney_decimal_point(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
...
ALObjectPtr Fput_money(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fput_num(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
    auto obj = eval->eval(t_obj->i(0));
    AL_CHECK(assert_number(obj));
...
ALObjectPtr Fput_time(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
...
ALObjectPtr Fisspace(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisblank(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fiscntrl(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisupper(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fislower(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisalpha(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisdigit(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fispunct(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisxdigit(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisalnum(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisprint(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Fisgraph(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<2>(t_obj));
...
ALObjectPtr Freset_locale(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *)
{
...
ALObjectPtr Fset_preffered(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *)
{
    AL_CHECK(assert_size<0>(t_obj));
...
ALObjectPtr Flocale(const ALObjectPtr &t_obj, env::Environment *env, eval::Evaluator *eval)
{
...
ALObjectPtr Flocale_name(const ALObjectPtr &t_obj, env::Environment *, eval::Evaluator *eval)
{
    AL_CHECK(assert_max_size<1>(t_obj));
