...
ALISP_EXPORT alisp::env::ModulePtr init_locale(alisp::env::Environment *, alisp::eval::Evaluator *)
{
    ...
    module_defun<loc::locale_name>(loc_ptr);
    module_defun<loc::set_default_locale>(loc_ptr);
    module_defun<loc::locale>(loc_ptr);
    module_defun<loc::num_true_name>(loc_ptr);
    module_defun<loc::num_thousand_sep>(loc_ptr);
    module_defun<loc::num_decimal_point>(loc_ptr);
    module_defun<loc::money_positive_sign>(loc_ptr);
    module_defun<loc::money_negative_sign>(loc_ptr);
    module_defun<loc::money_symobl>(loc_ptr);
    module_defun<loc::money_thousand_sep>(loc_ptr);
    module_defun<loc::money_decimal_point>(loc_ptr);
    module_defun<loc::put_money>(loc_ptr);
    module_defun<loc::put_num>(loc_ptr);
    module_defun<loc::put_time>(loc_ptr);
    module_defun<loc::isspace>(loc_ptr);
    module_defun<loc::isblank>(loc_ptr);
    module_defun<loc::iscntrl>(loc_ptr);
    module_defun<loc::isupper>(loc_ptr);
    module_defun<loc::islower>(loc_ptr);
    module_defun<loc::isalpha>(loc_ptr);
    module_defun<loc::isdigit>(loc_ptr);
    module_defun<loc::ispunct>(loc_ptr);
    module_defun<loc::isxdigit>(loc_ptr);
    module_defun<loc::isalnum>(loc_ptr);
    module_defun<loc::isprint>(loc_ptr);
    module_defun<loc::isgraph>(loc_ptr);
    module_defun<loc::reset_locale>(loc_ptr);
    module_defun<loc::set_preffered>(loc_ptr);
    module_defun<loc::locale>(loc_ptr);
